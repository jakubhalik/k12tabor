        ...
        const updateImage = (
            ...
            return setInterval(() => {
                setImageSrcs((prevSrcs) => {
                    const currentIndex = imageSets[category].indexOf(
                        prevSrcs[category]
                    );
                    const nextIndex =
                        (currentIndex + 1) % imageSets[category].length;
                    return {
                        ...prevSrcs,
                        [category]: imageSets[category][nextIndex],
                    };
                });
            }, interval);
        };
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Card className="bg-white rounded-lg shadow-lg">
                ...
                <CardContent className="p-4">
                    ...
                    <CardDescription className="text-gray-600 dark:text-black">
                        S naším sborem v Medlánkách děláme všechny možné akce,
                        pro rodiny, děti, dospělé. Např. kluby maminek, anglické
                        večery, atd.
                    </CardDescription>
                </CardContent>
            </Card>
