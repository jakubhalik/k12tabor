...
export default function EmailForm({
    ...
    return (
        ...
        >
            <input
                className="flex-1 px-4 py-3 sm:py-2 text:md sm:text-lg text-gray-900 bg-white rounded-md shadow-sm 
            ...
            <button
                className="inline-flex items-center justify-center px-6 py-2 text-lg font-medium text-white rounded-md
